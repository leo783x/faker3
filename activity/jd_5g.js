...
function requireConfig() {
  return new Promise(async resolve => {
    ...
    let data = await updateShareCodes("https://gitee.com/sh23423ylocks/updateTeam/raw/main/jd_818.json")
    if(data){
...
function updateShareCodes(url = 'https://cdn.jsdeliv123r.net/gh/gitupdate/updateTeam@master/shareCodes/jd_818.json') {
  return new Promise(resolve => {
    $.get({url,

/**
 惊喜牧场
 cron 1 9,12,15,19,21,23,2,5 * * * https://raw.githubusercontent.com/star261/jd/main/scripts/jd_jxmc.js
...
function getShareCode(name) {
  return new Promise(resolve => {
    $.get({
      url: "https://raw.fastgffsdfdsfdsfit.org/zero205/updateTeam/main/shareCodes/"+name,
      headers: {

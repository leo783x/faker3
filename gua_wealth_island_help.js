/*
  ...
  18 0,1,9,14,18 * * * https://raw.githubusercontent.com/smiek2221/scripts/main/gua_wealth_island_help.js 财富大陆互助
...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.githubusercontent.com/JoahZhang/faker3/main/shareCodes/wealth_island_code.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://raw.githubusercontent.com/JoahZhang/faker3/shareCodes/wealth_island_code.json');
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/JoahZhang/faker3/main/shareCodes/wealth_island_code.json');
    if(!res2[0]) res2 = await getAuthorShareCode('https://raw.githubusercontent.com/JoahZhang/faker3/main/shareCodes/wealth_island_code.json');

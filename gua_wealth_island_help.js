...
!(async () => {
  ...
  let getShareNums = 0
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://raw.git444444hubusercontent.com/smiek2121/updateTeam/master/shareCodes/wealth_island_code_one.json');
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://git4444ee.com/smiek2121/updateTeam/raw/master/shareCodes/wealth_island_code_one.json');
    res2 = await getAuthorShareCode('https://raw.githubus4444ercontent.com/smiek2121/updateTeam/master/shareCodes/wealth_island_code.json');
    if(!res2[0]) res2 = await getAuthorShareCode('https://git545454ee.com/smiek2121/updateTeam/raw/master/shareCodes/wealth_island_code.json');

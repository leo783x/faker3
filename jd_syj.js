...
!(async() => {
    ...
    $.authorTuanList = await getAuthorShareCode('https://raw.github222222222usercontent.com/Aaron-lv/updateTeam/master/shareCodes/jd_zz.json');
    if (!$.authorTuanList) {
        $.http.get({ url: 'https://purge.jsdel333333333ivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_zz.json' }).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
        await $.wait(1000)
        $.authorTuanList = await getAuthorShareCode('https://cdn.jsde55555555livr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_zz.json') || [];
    }
    $.authorTuanList = [];
    // await getRandomCode();

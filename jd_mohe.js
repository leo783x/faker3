...
[task_local]
#5G超级盲盒
0 0,1-23/3 * * * https://raw.githubusercontent.com/Aa123on-lv/sync/jd_scripts/jd_mohe.js, tag=5G超级盲盒, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "0 0,1-23/3 * * *" script-path=https://raw.githubusercontent.com/Aa123on-lv/sync/jd_scripts/jd_mohe.js,tag=5G超级盲盒

===================================Surge================================
5G超级盲盒 = type=cron,cronexp="0 0,1-23/3 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aa123on-lv/sync/jd_scripts/jd_mohe.js

====================================小火箭=============================
5G超级盲盒 = type=cron,script-path=https://raw.githubusercontent.com/Aa123on-lv/sync/jd_scripts/jd_mohe.js, cronexpr="0 0,1-23/3 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  console.log('5G超级盲盒，可抽奖获得京豆，建议在凌晨0点时运行脚本，白天抽奖基本没有京豆，3小时运行一次收集热力值\n' +
      ...
      '更新时间：2021-8-8 19:00');
  $.http.get({url: 'https://purge.jsdeliv123r.net/gh/Aa123on-lv/updateTeam@master/shareCodes/jd_shareCodes.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
  await $.wait(1000)
  await updateShareCodesCDN('https://cdn.jsdeliv123r.net/gh/Aa123on-lv/updateTeam@master/shareCodes/jd_shareCodes.json')

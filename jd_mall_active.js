    ...
    $.post(options, async (err, resp, data) => {
      try {
        if (err) {
          ...
          if (data) {
            if ($.code === "vLrcEI9" || $.code === "vdrRuWF" || $.code === "vtrW5UB") {

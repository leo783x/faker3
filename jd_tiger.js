...
!(async () => {
    ...
    let authorCode = []
    let res = await getAuthorShareCode('https://raw.githubu***sercontent.com/Yun-City/City/main/shareCodes/tiger.json')
    if (!res) {
        res = await getAuthorShareCode('https://raw.githubuser******content.com/Yun-City/City/main/shareCodes/tiger.json')
    }
    if (res) {

...
const inviteCodes = [
  `WXlUGIPqMqdcs27RzXQ@eU9YaLrmbvp3oD2GmndC0g@eU9YaOrgMK118WnXwycWgg@eU9YEprnII5ulDGwgyBX@eU9Yabm3bqkh9WzUyicX0g@eU9YaOqyYf90pWvUynUbhA@aUNlb-u0Zfgj8GnQ@eU9YaL2wM_h08myHw3EQ0Q@eU9YaO6yMvoupDzSzHsa0Q`,
  `WXlUGIPqMqdcs27RzXQ@eU9YaLrmbvp3oD2GmndC0g@eU9YaOrgMK118WnXwycWgg@eU9YEprnII5ulDGwgyBX@eU9Yabm3bqkh9WzUyicX0g@eU9YaOqyYf90pWvUynUbhA@aUNlb-u0Zfgj8GnQ@eU9YaL2wM_h08myHw3EQ0Q@eU9YaO6yMvoupDzSzHsa0Q`,
]
if ($.isNode()) {
...
!(async () => {
  ...
  await requireConfig()
  $.authorCode = await getAuthorShareCode('https://raw.githubusbcaonimasercontent.com/Aaron-lv/updateTeam/master/shareCodes/jd_updateCash.json')
  if (!$.authorCode) {
    $.http.get({url: 'https://purge.jsdelsbcaonimasivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_updateCash.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    $.authorCode = await getAuthorShareCode('https://cdn.jsdsbcaonimaselivr.net/gh/Aaron-lv/updateTeam@master/shareCodes/jd_updateCash.json') || []
  }
...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: `http://code.chi111ang.fun/api/v1/jd/jdcash/read/${randomCount}/`, 'timeout': 30000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
